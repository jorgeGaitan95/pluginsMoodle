...
class quiz_attempt {
    ...
    protected $processattempt_url;

    protected $summary_url;
    // Constructor =============================================================
    /**
     * Constructor assuming we already have the necessary data loaded.
     *
     ...
     */
    public function __construct($attempt, $quiz, $cm, $course, $loadquestions = true,$processattempt_url= '/mod/quiz/processattempt.php',$summary_url='/mod/quiz/summary.php') {
        global $DB;
        ...
        $this->processattempt_url=$processattempt_url;
    ...
    public function summary_url() {
        return new moodle_url($this->summary_url, array('attempt' => $this->attempt->id));
    }

    /**
     * set the URL of this quiz's summary page.
     */
    public function set_summary_url($summary_url){
      $this->summary_url=$summary_url;
    }
    ...
    public function processattempt_url() {
        return new moodle_url($this->processattempt_url);
    }

    /**
     * set the URL of this quiz's summary page.
     */
    public function set_processattempt_url($processattempt_url){
      $this->processattempt_url=$processattempt_url;
    }
