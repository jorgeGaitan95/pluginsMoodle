...
$string['estrategia_didacticaname'] = 'flow diagram name';
$string['estrategia_didacticaname_help'] = 'This is the content of the help tooltip associated with the newmodulename field. Markdown syntax is supported.';
$string['estrategia_didactica'] = 'Estrategia Didactica';
$string['pluginadministration'] = 'Estrategia Didactica administration';
$string['pluginname'] = 'Estrategia Didactica';
