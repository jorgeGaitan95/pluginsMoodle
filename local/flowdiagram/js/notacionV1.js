require(['local_flowdiagram/go','jquery','core/ajax'], function (go,jquery,ajax){
  ...
  myDiagram =$(go.Diagram, "myDiagramDiv",  // must name or refer to the DIV HTML element
  {
    ...
    function initNodeData(){
      var nodedata = [
        {"category":"Activity", "name":"Conceptos\nBásicos", tipoActividad:"asimilativas", subtipoActividad:"Formacion", "key":-2, "loc":"-12.984375000000014 -197.00000000000006", strokeActivity:"#F7C296", tipoInteraccion:"img/diagramIcons/W.svg",Actor:"img/diagramIcons/Individual AUX.svg",activityType:"img/diagramIcons/Presentacion.svg",fillActivity:$(go.Brush, "Linear", { 0: "white", 1: "#FBE9DA", start:go.Spot.Right })},
        ...
        {"category":"sincronozación", "key":-9, "loc":"-5.984375 81.00000000000001"},
